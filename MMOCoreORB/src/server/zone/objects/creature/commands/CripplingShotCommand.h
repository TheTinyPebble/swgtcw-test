...
protected:
	String skillName = "cripplingShot";		// Skill Name
	String tarSkillName = "targetCripple";
	String skillNameDisplay = "Crippling Shot";		// Skill Display Name for output message
