...
void PlayerManagerImplementation::sendPlayerToCloner(CreatureObject* player, uint64 clonerID, int typeofdeath) {
	...
	if (typeofdeath == 1) {
		doEnhanceCharacter(0x98321369, player, -500, 300, BuffType::OTHER, 0);
		doEnhanceCharacter(0x35D64963, player, -500, 300, BuffType::OTHER, 1);
		doEnhanceCharacter(0x2412A7EC, player, -500, 300, BuffType::OTHER, 2);
...
void PlayerManagerImplementation::grantJediTank(CreatureObject* player){
	PlayerObject* ghost = player->getPlayerObject();
...
void PlayerManagerImplementation::grantJediHealer(CreatureObject* player){
	PlayerObject* ghost = player->getPlayerObject();
...
void PlayerManagerImplementation::grantJediPowers(CreatureObject* player){
	PlayerObject* ghost = player->getPlayerObject();
