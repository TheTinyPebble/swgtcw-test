clonetrooper_bombardier_501 = Creature:new {
	objectName = "@mob/creature_names:clonetrooper_bombardier_501",
...
CreatureTemplates:addCreatureTemplate(clonetrooper_bombardier_501, "clonetrooper_bombardier_501")
