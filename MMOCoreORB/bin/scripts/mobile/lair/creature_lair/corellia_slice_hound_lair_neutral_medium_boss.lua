...
corellia_slice_hound_lair_neutral_medium_boss = Lair:new {
	mobiles = {{"slice_hound",1},{"female_slice_hound",1}},
	bossMobiles = {{"alpha_slice_hound",1}},
	spawnLimit = 15,
...
addLairTemplate("corellia_slice_hound_lair_neutral_medium_boss", corellia_slice_hound_lair_neutral_medium_boss)
