...
object_building_player_player_house_generic_medium_style_02 = object_building_player_shared_player_house_generic_medium_style_02:new {
	...
	shopSigns = {
		...
		{templateFile = "object/tangible/sign/player/wod_sm_hanging_sign_01.iff", x = 2.55, z = 2.25, y = 7.52, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "loot_sign_01", suiItem = "@player_structure:wod_sm_hanging_sign_01"},
		{templateFile = "object/tangible/sign/player/wod_sm_standing_sign_01.iff", x = 11.79, z = 0.5, y = 11.64, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1, requiredSkill = "loot_sign_02", suiItem = "@player_structure:wod_sm_standing_sign_01"},
		{templateFile = "object/tangible/sign/player/wod_sm_banner_sign_01.iff", x = 2.55, z = 2.25, y = 7.52, ox = 0, oy = 1, oz = 0, ow = 0, containmentType = -1, requiredSkill = "loot_sign_03", suiItem = "@player_structure:wod_sm_banner_sign_01"},
		{templateFile = "object/tangible/sign/player/wod_sm_banner_sign_02.iff", x = 2.55, z = 2.25, y = 7.52, ox = 0, oy = 1, oz = 0, ow = 0, containmentType = -1, requiredSkill = "loot_sign_04", suiItem = "@player_structure:wod_sm_banner_sign_02"},
		{templateFile = "object/tangible/sign/player/wod_sm_banner_sign_03.iff", x = 2.55, z = 2.25, y = 7.52, ox = 0, oy = 1, oz = 0, ow = 0, containmentType = -1, requiredSkill = "loot_sign_05", suiItem = "@player_structure:wod_sm_banner_sign_03"},
	},
