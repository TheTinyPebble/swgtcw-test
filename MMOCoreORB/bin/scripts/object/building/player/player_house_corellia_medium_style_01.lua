...
object_building_player_player_house_corellia_medium_style_01 = object_building_player_shared_player_house_corellia_medium_style_01:new {
	...
	shopSigns = {
		...
		{templateFile = "object/tangible/sign/player/wod_sm_standing_sign_01.iff", x = 11.79, z = 0.5, y = 11.64, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1, requiredSkill = "loot_sign_02", suiItem = "@player_structure:wod_sm_standing_sign_01"},
