...
object_tangible_beta_beta_terminal_warp = object_tangible_beta_shared_beta_terminal_warp:new {
	...
	customName = "Clone Wars Reward Terminal",
	...
	itemList = {
			"[CIS] Roll Krayt Dragon loot (4,000 CW Currency)", "ancient_roll_rebel",
			"[Republic] Roll Krayt Dragon loot (4,000 CW Currency)", "ancient_roll_imperial",
