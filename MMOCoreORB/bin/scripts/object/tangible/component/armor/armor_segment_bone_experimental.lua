...
object_tangible_component_armor_armor_segment_bone_experimental = object_tangible_component_armor_shared_armor_segment_bone_experimental:new {
	...
	experimentalMin = {0, 0, 1000, 1, 200, 10, 10, 13, 1, 3, 1, 200},
	experimentalMax = {0, 0, 1000, 10, 2000, 1, 1, 1, 1, 3, 10, 2000},
	experimentalPrecision = {0, 0, 0, 10, 0, 0, 0, 0, 0, 0, 0, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 1, 1, 4, 4, 4, 1},
}

ObjectTemplates:addTemplate(object_tangible_component_armor_armor_segment_bone_experimental, "object/tangible/component/armor/armor_segment_bone_experimental.iff")
