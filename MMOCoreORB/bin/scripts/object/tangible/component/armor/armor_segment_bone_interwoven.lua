...
object_tangible_component_armor_armor_segment_bone_interwoven = object_tangible_component_armor_shared_armor_segment_bone_interwoven:new {
...
ObjectTemplates:addTemplate(object_tangible_component_armor_armor_segment_bone_interwoven, "object/tangible/component/armor/armor_segment_bone_interwoven.iff")
