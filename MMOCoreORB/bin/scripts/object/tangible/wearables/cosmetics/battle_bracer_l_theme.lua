...
object_tangible_wearables_cosmetics_rebel_battle_bracer_l = object_tangible_wearables_cosmetics_shared_rebel_battle_bracer_l:new {
	faction = "Rebel",
...
ObjectTemplates:addTemplate(object_tangible_wearables_cosmetics_rebel_battle_bracer_l, "object/tangible/wearables/cosmetics/rebel_battle_bracer_l.iff")
