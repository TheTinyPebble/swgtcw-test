...
object_tangible_wearables_cosmetics_helmet_atat2 = object_tangible_wearables_cosmetics_shared_helmet_atat2:new {
	faction = "Imperial",
...
ObjectTemplates:addTemplate(object_tangible_wearables_cosmetics_helmet_atat2, "object/tangible/wearables/cosmetics/helmet_atat2.iff")
