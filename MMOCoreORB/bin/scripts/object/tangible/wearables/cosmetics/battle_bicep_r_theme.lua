...
object_tangible_wearables_cosmetics_rebel_battle_bicep_r = object_tangible_wearables_cosmetics_shared_rebel_battle_bicep_r:new {
	faction = "Imperial",
...
ObjectTemplates:addTemplate(object_tangible_wearables_cosmetics_rebel_battle_bicep_r, "object/tangible/wearables/cosmetics/rebel_battle_bicep_r.iff")
