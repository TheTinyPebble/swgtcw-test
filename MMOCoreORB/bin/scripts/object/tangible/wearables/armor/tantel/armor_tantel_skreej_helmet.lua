...
object_tangible_wearables_armor_tantel_armor_tantel_skreej_helmet = object_tangible_wearables_armor_tantel_shared_armor_tantel_skreej_helmet:new {
	...
	vulnerability = COLD + HEAT + ELECTRICITY + LIGHTSABER,
	specialResists = STUN,
	...
	experimentalMin = {0, 0, 0, 1000, 1, 20000, 100, 100, 275, 1, 8, 0, 0},
	experimentalMax = {0, 0, 0, 1000, 20, 30000, 25, 25, 125, 1, 8, 0, 0},
