...
object_tangible_wearables_armor_bone_armor_bone_s01_boots = object_tangible_wearables_armor_bone_shared_armor_bone_s01_boots:new {
	...
	vulnerability = STUN + HEAT + ELECTRICITY + LIGHTSABER,
	...
	experimentalMin = {0, 0, 0, 1000, 1, 20000, 100, 275, 100, 1, 64, 0, 0},
	experimentalMax = {0, 0, 0, 1000, 20, 30000, 25, 125, 25, 1, 64, 0, 0},
