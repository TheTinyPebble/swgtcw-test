...
ObjectTemplates:addTemplate(object_tangible_wearables_helmet_helmet_fighter_rebel_ace_craft, "object/tangible/wearables/helmet/helmet_fighter_rebel_ace_craft.iff")