object_building_player_player_house_wod_sm_hut = object_building_player_shared_player_house_wod_sm_hut:new {
	...
	shopSigns = {
		...
		{templateFile = "object/tangible/sign/player/wod_sm_hanging_sign_01.iff", x = -1.75, z = 2.7, y = 5.22, ox = 0, oy = -1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "loot_sign_01", suiItem = "@player_structure:wod_sm_hanging_sign_01"},
		...
		{templateFile = "object/tangible/sign/player/wod_sm_banner_sign_01.iff", x = -1.75, z = 2.7, y = 5.22, ox = 0, oy = -1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "loot_sign_03", suiItem = "@player_structure:wod_sm_banner_sign_01"},
		{templateFile = "object/tangible/sign/player/wod_sm_banner_sign_02.iff", x = -1.75, z = 2.7, y = 5.22, ox = 0, oy = -1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "loot_sign_04", suiItem = "@player_structure:wod_sm_banner_sign_02"},
		{templateFile = "object/tangible/sign/player/wod_sm_banner_sign_03.iff", x = -1.75, z = 2.7, y = 5.22, ox = 0, oy = -1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "loot_sign_05", suiItem = "@player_structure:wod_sm_banner_sign_03"},
	}
}
