object_building_dathomir_player_house_wod_ns_hut = object_building_dathomir_shared_player_house_wod_ns_hut:new {
	lotSize = 1,
...
ObjectTemplates:addTemplate(object_building_dathomir_player_house_wod_ns_hut, "object/building/dathomir/player_house_wod_ns_hut.iff")