...
function ImperialDetachmentHQScreenPlay:spawnMobiles()
	...
	-- Entrance
	spawnMobile("tatooine", "clonetrooper", 300, -2589.75, 5, 2116.08, -90, 0)
	spawnMobile("tatooine", "clonetrooper", 300, -2590.52, 5, 2111.61, -90, 0)
	spawnMobile("tatooine", "clonetrooper", 300, -2591.35, 5, 2107.1, -90, 0)
	spawnMobile("tatooine", "clonetrooper", 300, -2592.6, 5, 2100.61, -90, 0)
	...
	-- Office Exterior
	spawnMobile("tatooine", "clonetrooper", 300, -2573.94, 5.5, 2131.27, 180, 0)
	
	-- Barracks Exterior
	spawnMobile("tatooine", "clonetrooper", 300, -2568.7, 5.69, 2118.6, -90, 0)
	
	-- Bunker Exterior
	spawnMobile("tatooine", "clonetrooper", 300, -2576.48, 5.36, 2098.1, -90, 0)
	...
	-- Bunker Interior
		...
		-- Corridor
		spawnMobile("tatooine", "clonetrooper", 300, 3.81, 0.25, -3.84, 0, 1250068)
		
		-- Foyer
		spawnMobile("tatooine", "clonetrooper", 300, 5.98, -6.75, -9.32, 0, 1250071)
		spawnMobile("tatooine", "clonetrooper", 300, 3.07, 6.75, -9.71, 0, 1250071)
		spawnMobile("tatooine", "imperial_noncom", 300, 6.81, -6.75, -3.09, 180, 1250071)
		
		-- Mess hall
		spawnMobile("tatooine", "clonetrooper", 300, -5.05, -13.75, 6.70, -176, 1250073)
		spawnMobile("tatooine", "clonetrooper", 300, -2.16, -13.75, 6.70, -176, 1250073)
		...
		spawnMobile("tatooine", "clonetrooper_major", 300, 16.45, -13.75, 11.56, 180, 1250075)
		...
		spawnMobile("tatooine", "clonetrooper_major", 300, 14.0, -13.75, -16.2, 0, 1250076)
		spawnMobile("tatooine", "clonetrooper_major_general", 300, 16.0, -13.75, -13.8, 180, 1250076)
