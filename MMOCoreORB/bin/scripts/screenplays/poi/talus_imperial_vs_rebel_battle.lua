...
function TalusImperialVsRebelBattleScreenPlay:spawnMobiles()
	...
	pNpc = spawnMobile("talus", "cis_battle_droid", 870, -2539.5, 38.0, 3710.5, -27, 0)
	self:setMoodString(pNpc, "happy")
	pNpc = spawnMobile("talus", "cis_battle_droid_scout", 870, -2543.6, 38.1, 3729.2, -19, 0)
	self:setMoodString(pNpc, "nervous")
	pNpc = spawnMobile("talus", "cis_major_general", 870, -2538.3, 38.0, 3708.5, 100, 0)
