...
function TatooineImperialOasisBaseScreenPlay:spawnMobiles()
	...
	pNpc = spawnMobile("tatooine", "cis_battle_droid_specforce",60,5.3,0.1,-4.2,88,1289937)
	self:setMoodString(pNpc, "npc_use_terminal_low")
	...
	spawnMobile("tatooine", "clone_commando",360,-5360,8.0,2748.6,130,0)
	spawnMobile("tatooine", "clone_commando",360,-5357.5,8.0,2751.4,130,0)
	spawnMobile("tatooine", "clonetrooper_squad_leader",360,-5343.4,4.7,2733,120,0)
	...
	spawnMobile("tatooine", "clone_sand_trooper",360,-5289.8,7.5,2707,30,0)
	spawnMobile("tatooine", "clone_sand_trooper",360,-5292.8,7.2,2709.2,40,0)
	spawnMobile("tatooine", "clone_commando",600,-5310.7,8.5,2660.7,3,0)
	spawnMobile("tatooine", "clone_commando",600,-5304.0,8.5,2660.6,-7,0)
	spawnMobile("tatooine", "clone_sand_trooper",360,-5361.6,8.5,2661.8,-93,0)
	spawnMobile("tatooine", "clone_sand_trooper",360,-5362.5,7.6,2673.5,-120,0)
	spawnMobile("tatooine", "clonetrooper_sniper",360,-5339.1,7.5,2673.3,-97,0)
