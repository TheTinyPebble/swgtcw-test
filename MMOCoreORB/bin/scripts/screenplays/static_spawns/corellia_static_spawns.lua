...
function CorelliaStaticSpawnsScreenPlay:spawnMobiles()
	...
	spawnMobile("corellia", "cis_battle_droid_captain", 360,5.2,0.1,-3.6,-93,6036092)
	spawnMobile("corellia", "rebel_medic", 360,-4.4,0.1,-1.2,-11,6036093)
	spawnMobile("corellia", "cis_battle_droid_commando", 360,4110.3,24,-1260.3,-179,0)
	spawnMobile("corellia", "cis_battle_droid_commando", 360,4113.2,24,-1260.4,-179,0)
	spawnMobile("corellia", "cis_battle_droid", 360,4096.2,24,-1271.5,83,0)
	spawnMobile("corellia", "cis_sbd", 360,4098.3,24,-1271.4,-91,0)
	spawnMobile("corellia", "rep_at_xt", 360,4110.43,24.008,-1297.13,7,0)
	spawnMobile("corellia", "clonetrooper", 360, 4106.75,23.9281,-1295.73,7,0)
	spawnMobile("corellia", "clonetrooper", 360,4117.07,24.2994,-1293.08,-7,0)
	spawnMobile("corellia", "clonetrooper_squad_leader", 360, 4115.11,24.0521,-1289.97,-5,0)
	spawnMobile("corellia", "clonetrooper", 360, 4142.95,24,-1267.66,-77,0)
	spawnMobile("corellia", "clonetrooper", 360, 4132.13,24,-1269.63,-75,0)
	spawnMobile("corellia", "clonetrooper", 360, 4075.41,26.4493,-1269.93,90,0)
	spawnMobile("corellia", "clonetrooper", 360, 4066.41,35.4493,-1268.93,90,0)
