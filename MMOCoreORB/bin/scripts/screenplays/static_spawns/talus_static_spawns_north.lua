...
function TalusStaticSpawnsNorthScreenPlay:spawnMobiles()
	...
	local pNpc = spawnMobile("talus", "clonetrooper_squad_leader", 360, -2416.3, 28.3, 2034.3, 180, 0)
	self:setMoodString(pNpc, "npc_imperial")
	spawnMobile("talus", "clonetrooper_medic", 360, -2404.1, 27.2, 2036.8, 81, 0)
	spawnMobile("talus", "clonetrooper", 360, -2404.2, 27.3, 2031.2, 125, 0)
	spawnMobile("talus", "clone_commando", 360, -2403.9, 26.7, 2021.6, -90, 0)
	spawnMobile("talus", "clonetrooper_captain", 360, -2418.3, 28.4, 2034.8, 180, 0)
	spawnMobile("talus", "clonetrooper", 360, -2421.2, 28.3, 2028.2, 90, 0)
	spawnMobile("talus", "clonetrooper", 360, -2417.8, 27.6, 2022.3, 150, 0)
	spawnMobile("talus", "clonetrooper", 360, -2410.8, 27.2, 2014.5, 109, 0)
	spawnMobile("talus", "clonetrooper_medic", 360, -2411.6, 28.0, 2030.1, -165, 0)
	spawnMobile("talus", "clonetrooper_sniper", 360, -2412.4, 27.1, 2021.7, -30, 0)
	spawnMobile("talus", "clonetrooper_sniper", 360, -2419.8, 27.4, 2014.8, -125, 0)
	spawnMobile("talus", "clonetrooper", 360, -2398.3, 26.9, 2014.4, -15, 0)
	spawnMobile("talus", "clonetrooper", 360, -2392.4, 26.1, 2020.0, 45, 0)
	spawnMobile("talus", "clonetrooper", 360, -2389.6, 25.4, 2025.9, -22, 0)
	spawnMobile("talus", "clonetrooper_bombardier", 360, -2388.5, 24.7, 2032.9, 0, 0)
	spawnMobile("talus", "clonetrooper_bombardier", 360, -2379.8, 23.4, 2032.8, 0, 0)
	spawnMobile("talus", "clonetrooper", 360, -2364.2, 11.0, 2105.0, 40, 0)
	spawnMobile("talus", "clonetrooper", 360, -2369.2, 11.5, 2109.0, 40, 0)
	...
	spawnMobile("talus", "cis_battle_droid_commando", 300, -2601.8, 47.9, 101.0, 88, 0)
	spawnMobile("talus", "cis_battle_droid_commando", 300, -2605.7, 45.1, 88.6, -48, 0)
	spawnMobile("talus", "cis_battle_droid_commando", 300, -2609.7, 45.9, 97.7, 70, 0)
	spawnMobile("talus", "cis_battle_droid_commando", 300, -2618.8, 42.7, 91.7, 68, 0)
	spawnMobile("talus", "cis_battle_droid_commando", 300, -2613.2, 46.4, 114.5, 126, 0)
	...
	spawnMobile("talus", "clonetrooper", 360, 1695.4, 53.6, 1639.0, -22, 0)
	spawnMobile("talus", "clonetrooper", 360, 1673.7, 70.7, 1630.3, 48, 0)
	spawnMobile("talus", "clonetrooper", 360, 1672.6, 67.5, 1647.2, 102, 0)
	spawnMobile("talus", "clonetrooper", 360, 1710.6, 52.9, 1666.6, 142, 0)
	spawnMobile("talus", "clonetrooper", 360, 1770.3, 7.1, 1649.6, 101, 0)
	spawnMobile("talus", "clonetrooper", 360, 1779.9, 7.0, 1681.8, 126, 0)
	spawnMobile("talus", "clonetrooper", 360, 1702.6, 21.1, 1601.0, -112, 0)
	spawnMobile("talus", "clonetrooper", 360, -6.0, 0.7, -1.7, 0, 9505497)
	spawnMobile("talus", "imperial_pilot", 360, -1.0, 0.7, -6.9, -90, 9505498)
	spawnMobile("talus", "clonetrooper_medic", 360, -2.2, 0.7, -2.0, 90, 9505499)
	spawnMobile("talus", "clonetrooper_captain", 360, -2.2, 0.7, 4.3, 90, 9505500)
	...
	spawnMobile("talus", "clonetrooper_medic", 360, 3200.5, 6.3, 1261.9, -40, 0)
	spawnMobile("talus", "clonetrooper_sniper", 360, 3191.5, 5.1, 1269.0, -40, 0)
	spawnMobile("talus", "clonetrooper_sniper", 360, 3198.6, 5.3, 1274.0, -40, 0)
	spawnMobile("talus", "rep_at_xt", 720, 3202.0, 9.3, 1243.9, -40, 0)
	...
	spawnMobile("talus", "clonetrooper_sniper", 300, -2033.9, 141.7, 2807.1, 75, 0)
	spawnMobile("talus", "clonetrooper_sniper", 300, -2040.6, 141.0, 2816.8, 0, 0)
	spawnMobile("talus", "clonetrooper_sniper", 300, -2050.3, 141.2, 2819.5, -55, 0)
	spawnMobile("talus", "clonetrooper_sniper", 300, -2050.5, 140.6, 2811.7, -125, 0)
	spawnMobile("talus", "clonetrooper_sniper", 300, -2044.1, 141.6, 2806.9, 180, 0)
	spawnMobile("talus", "clonetrooper_squad_leader", 300, -2041.2, 140.7, 2811.6, -175, 0)

	--Road/Trail north of Imperial Outpost (-2255,2467) to (-2059,2444)
	spawnMobile("talus", "clonetrooper_squad_leader", 300, -2251.1, 66.7, 2487.0, -5, 0)
	spawnMobile("talus", "clonetrooper", 300, -2251.3, 67.4, 2491.0, -5, 0)
	spawnMobile("talus", "clonetrooper", 300, -2251.5, 68.0, 2495.0, -5, 0)
	spawnMobile("talus", "clonetrooper", 300, -2251.7, 68.6, 2499.0, -5, 0)
	spawnMobile("talus", "clonetrooper", 300, -2251.9, 69.1, 2503.0, -5, 0)
	spawnMobile("talus", "clonetrooper", 300, -2252.1, 69.6, 2507.0, -5, 0)
	spawnMobile("talus", "clonetrooper", 300, -2252.3, 70.0, 2511.0, -5, 0)
