...
function TalusStaticSpawnsSouthScreenPlay:spawnMobiles()
	...
	spawnMobile("talus", "cis_battle_droid_captain", 360, -4.4, 0.1, -3.5, 90, 9645417)
	spawnMobile("talus", "rebel_medic", 360, 3.7, 0.1, -3.7, -90, 9645416)
	spawnMobile("talus", "cis_battle_droid", 360, 0.0, 0.1, -4.8, 0, 9645414)
	spawnMobile("talus", "cis_battle_droid", 360, 3.9, 0.1, 1.6, -90, 9645415)
	spawnMobile("talus", "cis_battle_droid", 360, 0.0, 0.1, 4.2, 180, 9645412)
	spawnMobile("talus", "cis_battle_droid", 360, 2384.6, 125.3, -4989.8, 180, 0)
	spawnMobile("talus", "cis_battle_droid", 360, 2372.8, 125.7, -4989.8, 180, 0)
	spawnMobile("talus", "cis_battle_droid", 360, 2353.9, 125.4, -5004.1, -90, 0)

	--Tie Debris (4850,-4720)
	spawnMobile("talus", "foaming_vynock", 360, 4850.2, 93.8, -4727.0, -16, 0)

	--Rebel Camp (3100,-4044)
	spawnMobile("talus", "cis_battle_droid", 360, 3106.9, 65.8, -4057.9, 180, 0)
	spawnMobile("talus", "cis_battle_droid", 360, 3102.9, 65.8, -4057.9, 180, 0)
	spawnMobile("talus", "cis_battle_droid", 360, 3129.3, 65.6, -4043.5, 90, 0)
	spawnMobile("talus", "cis_battle_droid", 360, 3129.3, 65.6, -4039.5, 90, 0)
	spawnMobile("talus", "cis_battle_droid", 360, 3101.3, 65.9, -4013.7, 0, 0)
	spawnMobile("talus", "cis_battle_droid", 360, 3097.3, 65.9, -4013.7, 0, 0)
	spawnMobile("talus", "cis_battle_droid_specforce", 360, 3107.4, 65.8, -4034.0, -135, 0)
	spawnMobile("talus", "cis_battle_droid_specforce", 360, 3100.7, 65.8, -4048.9, 0, 0)
	--Debris (-1011,-5092)
	...
	--Campsite (-2716,-2265)
	spawnMobile("talus", "cis_battle_droid_commando", 360, -2713.4, 32.9, -2263.3, 60, 0)
	spawnMobile("talus", "cis_battle_droid_commando", 360, -2716.2, 32.6, -2273.2, -130, 0)
	...
	spawnMobile("talus", "clonetrooper_squad_leader", 300, 5947.4, 0.7, -1192.1, -108, 0)
	spawnMobile("talus", "clonetrooper", 300, 5963.3, 2.1, -1192.7, 158, 0)
