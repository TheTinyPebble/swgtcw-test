...
function BelaVistalScreenPlay:spawnMobiles()
	...
	spawnMobile("corellia", "clone_commando", 400, 6749.3, 315, -5684, 231.007, 0)
	spawnMobile("corellia", "clone_commando", 400, 6718.1, 328.537, -5869.6, 186.005, 0)
	spawnMobile("corellia", "imperial_noncom", 400, 6663.8, 330, -5913.3, 134.004, 0)
	spawnMobile("corellia", "clone_scout_trooper", 400, 6832.36, 314.758, -5811.93, 312.353, 0)
	spawnMobile("corellia", "clone_commando", 400, 6752.1, 315, -5823.5, 273.008, 0)
	spawnMobile("corellia", "clone_commando", 400, 6648.54, 330, -5939.32, 280.874, 0)
	spawnMobile("corellia", "clonetrooper", 400, 6852.9, 315, -5826.9, 140.004, 0)
	spawnMobile("corellia", "clonetrooper", 400, 6837.4, 315, -5774, 260.008, 0)
	spawnMobile("corellia", "clonetrooper", 400, 6819.9, 315, -5720.1, 220.006, 0)
	spawnMobile("corellia", "clonetrooper", 400, 6748.9, 315, -5665.2, 279.008, 0)
	spawnMobile("corellia", "clonetrooper", 400, 6855, 315, -5609.3, 280.008, 0)
	spawnMobile("corellia", "clonetrooper", 400, 6685.7, 330, -5943.3, 222.007, 0)
	spawnMobile("corellia", "clonetrooper", 400, 6708, 328.7, -5869.7, 166.005, 0)
	spawnMobile("corellia", "clonetrooper_sniper", 400, 6845.3, 315, -5826.8, 130.004, 0)
	spawnMobile("corellia", "noble",60, 6724.41, 330, -5909.35, 213.723, 0)
	spawnMobile("corellia", "clonetrooper_bombardier", 360, 6646.02, 330, -5931.59, 357.677, 0)
	spawnMobile("corellia", "clonetrooper_bombardier", 360, 6644.26, 330, -5937.08, 5.98245, 0)
	spawnMobile("corellia", "clonetrooper_bombardier", 360, 6649.56, 330, -5935.6, 128.564, 0)
	...
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("corellia", "clonetrooper_captain",400,6854.5,315,-5696.6,87,0)
	self:setMoodString(pNpc, "npc_imperial")
	pNpc = spawnMobile("corellia", "clonetrooper_squad_leader",400,6650.38,330,-5938.43,280.869,0)
	self:setMoodString(pNpc, "npc_imperial")
	...
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("corellia", "clonetrooper",400,6727.1,315,-5809.9,165,0)
	self:setMoodString(pNpc, "npc_imperial")
	pNpc = spawnMobile("corellia", "clonetrooper",400,6707.89,315,-5814.25,131.647,0)
	self:setMoodString(pNpc, "npc_imperial")
	pNpc = spawnMobile("corellia", "clonetrooper",400,6794.42,315,-5696.6,90.5594,0)
	self:setMoodString(pNpc, "npc_imperial")
	pNpc = spawnMobile("corellia", "clonetrooper",400,6826.7,315,-5820.68,309.206,0)
	self:setMoodString(pNpc, "npc_imperial")
	pNpc = spawnMobile("corellia", "clonetrooper",400,6825.35,315,-5620.37,277.216,0)
	self:setMoodString(pNpc, "npc_imperial")
	pNpc = spawnMobile("corellia", "clonetrooper",400,6842.92,315,-5604.11,56.0358,0)
	self:setMoodString(pNpc, "npc_imperial")
	pNpc = spawnMobile("corellia", "clonetrooper",400,6852,315,-5831.51,128.695,0)
	self:setMoodString(pNpc, "npc_imperial")
	pNpc = spawnMobile("corellia", "clonetrooper",400,6837.95,315,-5806.84,302.784,0)
	self:setMoodString(pNpc, "npc_imperial")
