...
function DantooineImperialOutpostScreenPlay:spawnMobiles()
	...
	spawnMobile("dantooine", "clonetrooper", 450, -4234, 3, -2382, 330, 0)
	spawnMobile("dantooine", "clonetrooper", 450, -4222, 3, -2398, 340, 0)
	spawnMobile("dantooine", "clonetrooper", 450, -4228, 3, -2398, 10, 0)
	spawnMobile("dantooine", "clonetrooper", 450, -4249, 3, -2395, 160, 0)
	spawnMobile("dantooine", "clonetrooper", 450, -4267, 3, -2388, 120, 0)
	spawnMobile("dantooine", "clonetrooper", 450, -4275, 3, -2404, 80, 0)
	spawnMobile("dantooine", "clonetrooper", 450, -4275, 3, -2412, 60, 0)
	spawnMobile("dantooine", "clonetrooper", 450, -4266, 3, -2431, 20, 0)
	spawnMobile("dantooine", "clonetrooper", 450, -4287, 3, -2414, 230, 0)
	spawnMobile("dantooine", "clonetrooper", 450, -4293, 3, -2397, 320, 0)
	spawnMobile("dantooine", "clonetrooper", 450, -4199, 3, -2342, 40, 0)
	spawnMobile("dantooine", "clonetrooper", 450, -4164, 3, -2400, 10, 0)
	spawnMobile("dantooine", "clonetrooper", 450, -4167, 3, -2410, 0, 0)
	spawnMobile("dantooine", "clonetrooper", 450, -4180, 3, -2408, 90, 0)
	spawnMobile("dantooine", "clonetrooper", 450, -4228, 3, -2410, 190, 0)
	spawnMobile("dantooine", "clonetrooper", 450, -4240, 3, -2421, 350, 0)
