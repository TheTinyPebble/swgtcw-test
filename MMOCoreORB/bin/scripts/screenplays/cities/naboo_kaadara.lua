NabooKaadaraScreenPlay = CityScreenPlay:new {
	...
	--spawn garrison outside city in the outskirts
		{"clonetrooper_501", "cis_battle_droid", 0, 0.3, 7.7, 0, 1259939, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 0, 0.3, 6.2, 0, 1259939, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 3.7, 0.3, -2.0, 0, 1259940, "", ""},
		{"clonetrooper_sniper_501", "cis_battle_droid_commando", -3.7, -3.3, 4.9, 180, 1259942, "", ""},
		{"clonetrooper_medic_501", "rebel_medic", 7.8, -6.8, -5.8, -65, 1259943, "", ""},
		{"rep_jedi_knight", "cis_magnaguard", 3.5, -6.8, -4.8, 0, 1259943, "", ""},
		{"clonetrooper_sniper_501", "cis_battle_droid_scout", -3.7, -13.8, -18.5, 90, 1259944, "", ""},
		{"rep_jedi_knight", "cis_battle_droid_captain", -0.9, -13.7, -4.7, -45, 1259945, "", ""},
		{"clonetrooper_501", "cis_battle_droid", -5.1, -13.7, 7.5, 180, 1259945, "", ""},
		{"clonetrooper_501", "cis_battle_droid", -1.9, -13.7, 7.5, 180, 1259945, "", ""},
		{"clonetrooper_medic_501", "rebel_medic", -5.3, -13.8, 13.5, -30, 1259950, "", ""},
		{"clonetrooper_squad_leader_501", "cis_general", 14.7, -13.8, 5.2, 0, 1260045, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 14.7, -13.8, 8.0, 0, 1260045, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 14.7, -13.8, 9.8, 0, 1260045, "", ""},
		{"imperial_army_captain", "cis_battle_droid_captain", 15.1, -11.5, -20.4, 0, 1260046, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 3.7, 0.1, 2.1, -90, 1260051, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 0, 0.1, -1.9, 0, 1260050, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 0, 0.1, -1.9, 0, 1260057, "", ""},
		{"rep_jedi_knight", "cis_sbd", 5.3, 0.1, 4.5, -150, 1260058, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 5384.5, -197.2, 6455, -97, 0, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 5384.5, -197.2, 6458, -97, 0, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 5381.5, -197.2, 6454.5, -97, 0, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 5381.5, -197.2, 6457.5, -97, 0, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 5378.5, -197.2, 6454, -97, 0, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 5378.5, -197.2, 6457, -97, 0, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 5375.5, -197.2, 6453.5, -97, 0, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 5375.5, -197.2, 6456.5, -97, 0, "", ""},

	--faction spawns inside the actual city limits
		{"clonetrooper_501", "cis_battle_droid", 5290.5, -192, 6582.2, -90, 0, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 5294.5, -192, 6582.2, -90, 0, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 5298.5, -192, 6582.2, -90, 0, "", ""},
		{"clonetrooper_501", "cis_battle_droid", getRandomNumber(20) + 5189.5, -192, getRandomNumber(28) + 6624.5, getRandomNumber(360), 0, "", ""},
		{"clonetrooper_medic_501", "rebel_medic", getRandomNumber(20) + 5189.5, -192, getRandomNumber(28) + 6624.5, getRandomNumber(360), 0, "", ""},
		{"rebel_gungan_bomber", "cis_battle_droid", getRandomNumber(20) + 5189.5, -192, getRandomNumber(28) + 6624.5, getRandomNumber(360), 0, "", ""},
		{"clonetrooper_501", "cis_battle_droid", getRandomNumber(20) + 5189.5, -192, getRandomNumber(20) + 6624.5, getRandomNumber(360), 0, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 29.9, 0.3, -2, -79, 1741439, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 18.6, 0.3, 9.5, -90, 1741439, "", ""},
		{"clonetrooper_501", "cis_battle_droid", -7.2, 0.3, -3.2, -111, 1741443, "", ""},
		{"clonetrooper_501", "cis_battle_droid", -18.4, 0.3, -6.6, -101, 1741443, "", ""},
		{"naboo_police", "naboo_police", 5095.7, -192, 6744.4, 136, 0, "", ""},
		{"naboo_police", "naboo_police", 5105.6, -192, 6733.9, 136, 0, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 5137.7, -192, 6692.9, 136, 0, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 5148.6, -192, 6682.4, 136, 0, "", ""},
		{"clonetrooper_501", "cis_battle_droid", 5023.0, -192, 6714.8, -40, 0, "", ""},
