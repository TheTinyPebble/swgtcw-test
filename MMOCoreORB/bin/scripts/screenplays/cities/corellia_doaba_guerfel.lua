CorelliaDoabaGuerfelScreenPlay = CityScreenPlay:new {
	...
	gcwMobs = {
		...
		{"dark_trooper", "cis_battle_droid_commando", 3173.3, 300, 5302.5, -155, 0, "npc_imperial", "neutral"},
		{"dark_trooper", "cis_battle_droid_commando", 3181, 302.9, 5099.8, 175, 0, "npc_imperial", "neutral"},
		{"elite_sand_trooper", "cis_battle_droid_scout", 3142.5, 300, 5169.9, 179, 0, "npc_imperial", "neutral"},
		{"elite_sand_trooper", "cis_battle_droid_scout", 3319.3, 308, 5523.9, 25, 0, "npc_imperial", "neutral"},
		...
		{"storm_commando", "cis_battle_droid_commando", 3181.3, 300, 5298.6, -147, 0, "", ""},
		{"stormtrooper", "cis_battle_droid", 3171.4, 301.9, 5100.1, 175, 0, "npc_imperial", "neutral"},
		{"stormtrooper", "cis_battle_droid", 3141.3, 290, 4984.9, -89, 0, "npc_imperial", "neutral"},
		{"stormtrooper_rifleman", "cis_battle_droid_captain", 3133.4, 300, 5169.9, 178, 0, "npc_imperial", "neutral"},
		{"stormtrooper_squad_leader", "cis_battle_droid_specforce", 3141.1, 290, 4975.7, -95, 0, "npc_imperial", "conversation"},
