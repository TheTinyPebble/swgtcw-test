...
function TatooineBestineScreenPlay:spawnMobiles()
	...
	spawnMobile("tatooine", "clonetrooper",400,-1278.5,12.5279,-3643.1,165.005,0)
	spawnMobile("tatooine", "clonetrooper",400,-1243.9,12,-3550.55,301.01,0)
	spawnMobile("tatooine", "clonetrooper",400,-1277.1,  12, -3533.8,301.01,0)
	spawnMobile("tatooine", "clonetrooper",400,-1150.5,12,-3547.1,26,0)
	spawnMobile("tatooine", "clonetrooper",400,-1097,12,-3525.3,121.004,0)
	pNpc = spawnMobile("tatooine", "clone_commando",400,-1430.36,12,-3728.58,141.26,0)
	self:setMoodString(pNpc, "npc_imperial")
	pNpc = spawnMobile("tatooine", "clone_commando",400,-1004.6,12,-3710.8,132,0)
	self:setMoodString(pNpc, "npc_imperial")
	pNpc = spawnMobile("tatooine", "clone_commando",400,-1428.52,12,-3730.88,141.264,0)
	self:setMoodString(pNpc, "npc_imperial")

	spawnMobile("tatooine", "clone_commando",400,-1453,12,-3646.95,42.076,0)
	pNpc = spawnMobile("tatooine", "clone_commando",400,-1002.9,12,-3705.4,-55,0)
	self:setMoodString(pNpc, "npc_imperial")
	spawnMobile("tatooine", "clonetrooper_squad_leader",400,-1284,12,-3486,180,0)
	pNpc = spawnMobile("tatooine", "clonetrooper_squad_leader",400,-1368.48,12,-3725.42,268.991,0)
	self:setMoodString(pNpc, "npc_imperial")
	spawnMobile("tatooine", "clonetrooper_squad_leader",400,-1276,12,-3487,180,0)
	pNpc = spawnMobile("tatooine", "clonetrooper_squad_leader",400,-1348.2,12,-3712.7,315,0)
	self:setMoodString(pNpc, "npc_imperial")
	pNpc = spawnMobile("tatooine", "clonetrooper_squad_leader",400,-1429.92,12,-3731.49,141.268,0)
	self:setMoodString(pNpc, "npc_imperial")
	spawnMobile("tatooine", "clonetrooper_squad_leader",400,-1275,12,-3507.5,315,0)
	pNpc = spawnMobile("tatooine", "clonetrooper_squad_leader",400,-1378.4,12,-3712.53,119.74,0)
	self:setMoodString(pNpc, "npc_imperial")
	pNpc = spawnMobile("tatooine", "clonetrooper_squad_leader",400,-984.262,12,-3742.5,126.391,0)
	self:setMoodString(pNpc, "npc_imperial")

	spawnMobile("tatooine", "clonetrooper_squad_leader",400,-1454.87,12,-3651.05,45.2754,0)
	spawnMobile("tatooine", "clonetrooper_squad_leader",400,-1455.96,12,-3650.25,42.1254,0)
	pNpc = spawnMobile("tatooine", "clonetrooper_squad_leader",400,-1058.39,12,-3671.09,222.747,0)
	self:setMoodString(pNpc, "npc_imperial")
	pNpc = spawnMobile("tatooine", "clonetrooper_squad_leader",400,-1049.04,12,-3660.19,249.5,0)
	self:setMoodString(pNpc, "npc_imperial")
	pNpc = spawnMobile("tatooine", "clone_sand_trooper",400,-983.8,12,-3746.5,116.003,0)
	pNpc = spawnMobile("tatooine", "clone_sand_trooper",400,-980.4,12,-3742.8,119,0)
	pNpc = spawnMobile("tatooine", "clone_sand_trooper",400,-1169.8,12,-3692.1,235.007,0)
	pNpc = spawnMobile("tatooine", "clone_sand_trooper",400,-1283.8,12,-3480.4,306.486,0)

	spawnMobile("tatooine", "clone_sand_trooper",400,-1275.6,12,-3479.9,0,0)
	spawnMobile("tatooine", "clone_sand_trooper",400,-1016.9,12,-3741.2,97.0029,0)
	spawnMobile("tatooine", "clone_sand_trooper",400,-1018.3,12,-3736.2,272.008,0)
	spawnMobile("tatooine", "clone_sand_trooper",400,-1089.8,12,-3704.2,116.003,0)
	spawnMobile("tatooine", "clone_sand_trooper",400,-1154.1,12,-3650,-111,0)

	--guard near city hall and shuttleport entryway
	spawnMobile("tatooine", "clone_sand_trooper",400,-1083.6,12,-3594.2,169.005,0)
	spawnMobile("tatooine", "clone_sand_trooper",400,-1092.1,12,-3595.4,169.005,0)

	--guard by guildhall exits
	spawnMobile("tatooine", "clone_sand_trooper",400,-1181.3,12,-3537.9,198.006,0)
	spawnMobile("tatooine", "clone_sand_trooper",400,-1181.3,12,-3542.5,198.006,0)

	spawnMobile("tatooine", "clone_commando",400,-1231.81,12,-3605.85,127.312,0)
	spawnMobile("tatooine", "clone_commando",400,-1292.8,12,-3585.5,133.004,0)

	spawnMobile("tatooine", "clonetrooper_sniper",400,-1093.7,14,-3660.2,41.0012,0)
	...
	pNpc = spawnMobile("tatooine", "clonetrooper_squad_leader",400,-1093.52,12,-3647.32,308.036,0)
	self:setMoodString(pNpc, "npc_imperial")

	--black stormtrooper by hutt informant
	pNpc = spawnMobile("tatooine", "clone_commando",0,-1115.14,12,-3639.18,263.058,0)
	self:setMoodString(pNpc, "npc_imperial")
