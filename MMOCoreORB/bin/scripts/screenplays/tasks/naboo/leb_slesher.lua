	...
	{
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "leb_merchant", npcName = "Phinta Lianovi" }
			},
			secondarySpawns = {},
			itemSpawns =
			{
		...
		},
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "leb_merchant", npcName = "Cornevero Dawlton" }
			},
			secondarySpawns = {},
			itemSpawns =
			{
...
npcMapLebSlesher =
	{
		{
			spawnData = { npcTemplate = "leb_slesher", x = 3.1, z = 0.9, y = 5.7, direction = 166, cellID = 64, position = STAND },
