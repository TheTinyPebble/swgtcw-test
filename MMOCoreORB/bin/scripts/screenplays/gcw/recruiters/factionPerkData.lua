...
imperialRewardData = {
	...
	weaponsArmor = {
			...
			armor_clonetrooper_utility_belt = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_clonetrooper_utility_belt_schematic", item="object/tangible/loot/loot_schematic/clonetrooper_utility_belt_crafted_schematic.iff",cost=1400},
